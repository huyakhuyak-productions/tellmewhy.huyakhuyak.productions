...
import { truncateToCodePoints } from "@/lib/text";
...
export default async function ConversationPage({
  ...
  // One request scope around the whole loader: this page unwraps the reader's
  // DEK across loadMessageTree and nearly every parallel read below (the tree
  // itself, conversation titles, mood, notes …). Scoping them together lets
  // getOrCreateUserDek memoize that unwrap to a single real one for the render,
  // never leaking it past this request (see request-scope.ts).
